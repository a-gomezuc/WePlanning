...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.GET,"/searchUsers/filter={filter}/usearch={usearch}").hasAnyRole("USER");
        http.authorizeRequests().antMatchers(HttpMethod.GET,"/searchUsers/filter={filter}/usearch={usearch}").hasAnyRole("ADMIN");*/
